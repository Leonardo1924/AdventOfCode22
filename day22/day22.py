...
class TreeToSteps(Transformer):
    steps = list
    def distance(self, other): return int(other[0])
    def right(self, other): return 'R'
    def left(self, other): return 'L'
...
rules = [
    None,
    { #rule1
        Direction.up: NewSide(6, Direction.right, lambda row, col: col, lambda row, col: 0),
        Direction.down: NewSide(3, Direction.down, lambda row, col: 0, lambda row, col : col),
        Direction.left: NewSide(4, Direction.right, lambda row, col: sideLength-1 - row, lambda row, col : 0),
        Direction.right: NewSide(2, Direction.right, lambda row, col: row, lambda row, col : 0)
    },
    { #rule2
        Direction.up: NewSide(6, Direction.up, lambda row, col: sideLength-1, lambda row, col: col),
        Direction.down: NewSide(3, Direction.left, lambda row, col:col, lambda row, col: sideLength-1),
        Direction.left: NewSide(1, Direction.left, lambda row, col: row, lambda row, col: sideLength - 1),
        Direction.right: NewSide(5, Direction.left, lambda row, col: sideLength-1 - row, lambda row, col: sideLength - 1)
    },
    { #rule3
        Direction.up: NewSide(1, Direction.up, lambda row, col: sideLength-1, lambda row, col: col),
        Direction.down: NewSide(5, Direction.down, lambda row, col: 0, lambda row, col: col),
        Direction.left: NewSide(4, Direction.down, lambda row, col: 0, lambda row, col: row),
        Direction.right: NewSide(2, Direction.up, lambda row, col: sideLength-1, lambda row, col: row)
    },
    { #rule4
        Direction.up: NewSide(3, Direction.right, lambda row, col: col, lambda row, col: 0),
        Direction.down: NewSide(6, Direction.down, lambda row, col: 0, lambda row, col: col),
        Direction.left: NewSide(1, Direction.right, lambda row, col: sideLength-1 - row, lambda row, col: 0),
        Direction.right: NewSide(5, Direction.right, lambda row, col: row, lambda row, col: 0)
    },
    { #rule5
        Direction.up: NewSide(3, Direction.up, lambda row, col: sideLength-1, lambda row, col: col),
        Direction.down: NewSide(6, Direction.left, lambda row, col: col, lambda row, col: sideLength-1),
        Direction.left: NewSide(4, Direction.left, lambda row, col: row, lambda row, col: sideLength-1),
        Direction.right: NewSide(2, Direction.left, lambda row, col: sideLength-1 - row, lambda row, col: sideLength-1)
    },
    { #rule6
        Direction.up: NewSide(4, Direction.up, lambda row, col: sideLength-1, lambda row, col: col),
        Direction.down: NewSide(2, Direction.down, lambda row, col:0, lambda row, col: col),
        Direction.left: NewSide(1, Direction.down, lambda row, col: 0, lambda row, col: row),
        Direction.right: NewSide(5, Direction.up, lambda row, col: sideLength-1, lambda row, col: row)
    }
]
